...
export default function YoneticiDashboard({ currentUserId }: YoneticiDashboardProps) {
  ...
  const tabContents = {
    ...
    loglar: (
      <div className="p-8 text-center text-gray-800">Loglar yakında...</div>
    ),
    sistem: (
      <div className="p-8 text-center text-gray-800">Sistem ayarları yakında...</div>
    ),
    dolaplar: (
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-900">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed md:static z-10 h-screen bg-white border-r border-gray-200 transition-all
      ...
      <main className="flex-1 w-full overflow-x-hidden">
        {/* Top Bar */}
        <div className="h-16 flex items-center justify-between px-4 border-b bg-white sticky top-0 z-40">
